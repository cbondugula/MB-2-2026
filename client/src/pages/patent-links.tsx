  ...
  return (
    <div className="container mx-auto p-6 max-w-4xl">
      <div className="bg-white rounded-lg shadow p-6">
        <h1 className="text-2xl font-bold mb-6">Patent Filing Links</h1>
        
        <div className="space-y-3">
          <div className="p-3 border rounded">
            <h3 className="font-medium">Patent 001</h3>
            <button 
              className="mt-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded text-sm flex items-center gap-2" 
              onClick={() => window.open(`/api/patents/individual/001`, '_blank')}
            >
