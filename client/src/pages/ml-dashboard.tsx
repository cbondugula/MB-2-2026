    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="text-center space-y-2">
        ...
        <div className="flex justify-center gap-2">
          <Badge variant="secondary" className="text-xs">Enterprise AI Technology</Badge>
          <Badge variant="secondary" className="text-xs">Enterprise AI Technology</Badge>
          <Badge variant="secondary" className="text-xs">Enterprise AI Technology</Badge>
        </div>
      </div>
        ...
        <TabsContent value="validation" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Enterprise AI Technology: Validate medical decisions using multiple AI models</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
        ...
        <TabsContent value="federated" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Enterprise AI Technology: Multi-institutional AI collaboration with privacy preservation</CardDescription>
            </CardHeader>
        ...
        <TabsContent value="workflow" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Enterprise AI Technology: AI-powered healthcare workflow automation</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
